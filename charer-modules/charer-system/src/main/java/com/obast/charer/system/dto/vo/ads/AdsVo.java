package com.obast.charer.system.dto.vo.ads;
...
@ApiModel(value = "AdsVo")
@Data
@ExcelIgnoreUnannotated
@AutoMapper(target = Ads.class, uses = {StringToListConverter.class}, convertGenerate = false)
public class AdsVo extends BaseDto {
