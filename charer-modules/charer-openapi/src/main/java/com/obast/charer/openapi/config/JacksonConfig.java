...
public class JacksonConfig {
    ...
    public TimeZone getTimeZone() {
        String language = charerProperties.getOpenapi().getI18n().getLanguage();
        I18nLocaleProperties i18nLocale = Arrays.stream(charerProperties.getOpenapi().getI18n().getLocales()).filter(item->item.getLocale().equals(language)).findFirst().orElse(null);
