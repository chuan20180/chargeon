...
import com.obast.charer.s3mock.dto.Error;
...
import com.obast.charer.s3mock.dto.Checksum;
...
import com.obast.charer.s3mock.dto.DeletedS3Object;
...
import com.obast.charer.s3mock.store.ObjectStore;
...
public class ObjectService {
  ...
  public InputStream verifyMd5(InputStream inputStream, String contentMd5,
    ...
    try {
      ...
      try (var stream = HeaderUtil.isV4ChunkedWithSigningEnabled(sha256Header)
